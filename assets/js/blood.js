...
document.addEventListener('DOMContentLoaded', function() {
  ...
  function showSecondDropdown(event, option) {
    ...
    if (option === "Option 1") {
      secondDropdownContent.innerHTML += `
        <a href="#salam" onclick="stopPropagation(event)">Al-Salam International Hospital</a>
        <a href="#elite" onclick="stopPropagation(event)">Elite Hospital</a>
        <a href="#anda" onclick="stopPropagation(event)">Andalusia Hospital</a>
        <a href="#safa" onclick="stopPropagation(event)">El Safa Hospital</a>
        <a href="#shifa" onclick="stopPropagation(event)">Shifa Hospital</a>
      `;
      secondDropbtn.textContent = "Filter by Hospital";
